...
media <- read_csv("movie_media_clean.csv", show_col_types = FALSE)
...
media <- read_csv("movie_media_clean.csv", show_col_types = FALSE)
sectors <- read_csv("sector_etfs_clean.csv", show_col_types = FALSE)
...
box_office <- read_csv("box_office.csv", show_col_types = FALSE)
