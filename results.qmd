...
- Compared with major market sectors, the movie industry’s recovery is much slower It performed well from late 2020 through 2022, but after 2022 the movie industry's stock price dropped a lot and still falls behind most other sectors to this date.
...
```
In 2020, box office revenue plunged from about $11B to just over $2B. Although it has returned to roughly $8B, it still hasn’t reached the old peak and now seems to be stuck at a lower level, which suggests that the movie industry may now be structurally smaller than it was before COVID.
...
Similar to Chart 1, the number of theatrical releases dropped sharply in 2020 and remained below pre-pandemic levels. This indicates that studios have reduced their annual output and released fewer films than before. And this will likely reflect shifts in production and distribution strategies, where companies might focus more on streaming services. 

### Chart 3. Percent Change in AMC Theatres by State (2019 vs 2024)
...
st_read("data/cb_2018_us_state_20m/cb_2018_us_state_20m.shp", quiet = TRUE)
)
...
ggplot(map_data) +
  ...
  labs(
    title    = "Percent change in AMC Theatres by State (2019 vs 2024)",
    subtitle = "(Light grey = no change; dark grey = no AMC theatres)",
...
## While most U.S. sectors recovered strongly post-COVID, the movie industry lags behind
...
This chart shows that two companies drove much of the volatility in the movie industry. This helps explain the sector’s brief strength from late 2020 to 2022 (see chart 4). For example, Roku’s share price rose sharply in 2020, corresponding to higher streaming usage during Covid. AMC experienced large price swings in early 2021. This was due to the “meme-stock” trading frenzy driven by movements from the reddit group wallstreetbets. These movements stood out from the rest of the movie industry. However, in 2022, both ROKU and AMC stocks trended downward, which reveals these were temporary movements rather than lasting increase.
...
## Performance of sub-industries within the movie industry differ

From previous two sections, we’ve seen the movie industry is indeed smaller than it was before COVID and has recovered much slower than other industries. We now look inside the movie industry. Different types of companies in the industry, such as streamers, theater, studios, and diversified media firms, may not move in the same way. In this section, we break the movie industry into these sub-industries to see how each one has evolved.
...
### Chart 8. Correlation Between Movie Sub-Industries (2019–2025)
...
ggplot(cor_long, aes(Var1, Var2, fill = Correlation)) +
  ...
  coord_fixed() +
  labs(
    title = "Correlation Between Movie Sub-Industries (2019– 2025)",
...
Diversified media firms move most closely with the overall market (correlation 0.84). Studios and theaters are moderately linked (0.66), and streamers and studios also track each other pretty well (0.74). Theaters are the real outlier here, as their prices move much less in sync with the rest of the industry. This suggests that theater companies may react to a different set of forces than streaming or diversified media firms.
...
```
Because each sub-industry contains only a few publicly traded companies, the chart is noisy. No strong or consistent patterns appear. The flows are better interpreted as broad observations of stock price movements rather than meaningful signals.
